...
const Footer = () => {
  ...
  <p>Sansad Bhavan ,delhi,india</p>
  <span className="font-semibold">akashyadav.me203@gmail.com</span>
  <span className="font-semibold">+91 123 4567 890</span>
  ...
  <div className="flex">
    ...
    <button className="w-1/4 bg-aksh text-white">JOIN</button>
    </div>
  ...
  <div className="flex flex-col md:flex-row items-center justify-between gap-8 mt-16">
    <div className="">© Akash shop 2024</div>
    <div className="">
      <div className="">
